...
test_agents = [torch.load('experiments/nolimitholdem_ppo_result9/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result10/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result19/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result20/model.pth')]
...
training_method_color = {
    'ppo_ckl-ppo_ckl': 'royalblue',
    'random': 'firebrick'
}

print(f"Test_agents gain {dqn_gain} chips.")
plot_bar(dqn_agent_names, dqn_gain, 'experiments/compare_ppo_ckl-ppo_ckl.png', num_of_games, training_method_color)
