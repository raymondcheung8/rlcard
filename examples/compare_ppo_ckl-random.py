''' Compare different models of ppo_clip_kl_div that are trained against a random agent
'''
...
test_agents = [torch.load('experiments/nolimitholdem_ppo_result5/model.pth'),
...
training_method_color = {
    'ppo_ckl-random': 'royalblue',
    'random': 'firebrick'
}

print(f"Test_agents gain {dqn_gain} chips.")
plot_bar(dqn_agent_names, dqn_gain, 'experiments/compare_ppo_ckl-random.png', num_of_games, training_method_color)
