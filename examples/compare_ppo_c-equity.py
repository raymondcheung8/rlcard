''' Compare different models of ppo_clip that are trained against an equity agent
'''
...
test_agents = [torch.load('experiments/nolimitholdem_ppo_result11/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result12/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result21/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result22/model.pth')]
...
training_method_color = {
    'ppo_c-equity': 'royalblue',
    'random': 'firebrick'
}

print(f"Test_agents gain {dqn_gain} chips.")
plot_bar(dqn_agent_names, dqn_gain, 'experiments/compare_ppo_c-equity.png', num_of_games, training_method_color)
