''' Compare different models of ppo_clip that are trained against a random agent
'''
...
test_agents = [torch.load('experiments/nolimitholdem_ppo_result/model.pth'),
               ...
               torch.load('experiments/nolimitholdem_ppo_result15/model.pth'),
               torch.load('experiments/nolimitholdem_ppo_result16/model.pth')]
...
plot_bar(dqn_agent_names, dqn_gain, 'experiments/compare_ppo_c-random.png', num_of_games, training_method_color)
